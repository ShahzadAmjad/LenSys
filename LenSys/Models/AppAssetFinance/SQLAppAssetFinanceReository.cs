...
namespace LenSys.Models.AppAssetFinance
{
    public class SQLAppAssetFinanceReository : IAppAssetFinanceRepository
    {
        ...
        {
            AppAssetFinance appAssetFinance = GetAppAssetFinance(id);
        ...
        public IEnumerable<AllApplications> GetAllAppAssetFinance_AllApplication()
        {
            ...
            allApplicationsList = Context.AppAssetFinance.Include(x => x.Lead).Select(p=> new AllApplications { AppID=p.AssetFinId,LeadId=p.Lead.LeadId, Type=p.Lead.LoanPurpose, CompanyBusinessName = p.Lead.CompanyBusniessName }).ToList();
                ...
                foreach (var Childindivdual in AppAssetFinanceChanges.individuals)
                {
                    ...
                    {                       
                       ...
                       // List<PropertySchedule> _propertySchedule = new List<PropertySchedule>(){};
                        ...
                        newChildAppAssetFinanceIndividual.individualDocuments = new List<IndividualDocuments>() { };
                        ...
                        foreach (var childDocument in Childindivdual.individualDocuments)
                        {
                            ...
                            newChildAppAssetFinanceIndividual.individualDocuments.Add(document);
                        }
        ...
        public IEnumerable<AllApplications> SearchAppAssetFinance(string SearchAttribute, string SearchParam)
        {
            List<AllApplications> allApplicationsList = new List<AllApplications>();
            allApplicationsList = Context.AppAssetFinance.Include(x => x.Lead).Select(p => new AllApplications { AppID = p.AssetFinId, LeadId = p.Lead.LeadId, Type = p.Lead.LoanPurpose, CompanyBusinessName = p.Lead.CompanyBusniessName }).ToList();
