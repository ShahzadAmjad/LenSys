...
namespace LenSys.Models.AppPropertyFinance.AppPropertyFinanceBusniess
{
    public class MockAppPropertyFinanceBusniessRepository : IAppPropertyFinanceBusniessRepository
    {
        ...
        {
            _busniess = new List<AppPropertyFinanceBusniess>()
            {
                                //new Busniess{
        ...
        public IEnumerable<AppPropertyFinanceBusniess> ClearBusniessList()
        {
            _busniess.Clear();
            return _busniess;
        }
        ...
        public IEnumerable<AppPropertyFinanceBusniess> SetBusniessList(IEnumerable<AppPropertyFinanceBusniess> BusniessList)
        {
            _busniess = (List<AppPropertyFinanceBusniess>)BusniessList;
            return _busniess;
        }
